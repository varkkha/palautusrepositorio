...
class TestKauppa(unittest.TestCase):
    ...
    def test_kahden_ostoksen_paatyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_argumenteilla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_poista_korista(self):
        ...
        varasto_mock.palauta_varastoon = Mock()
        ...
        self.assertEqual(varasto_mock.saldo(1), 10)
